...
// table list
@Form.create()
class PersonalProp extends PureComponent {
  state = {
    isLoading: false,
    selectedRows: [],
    selectedRowsLevel1: [],
  ...
  componentDidMount = async () => {
    this.setIsLoad(true);
    const dictionary = await dictionariesMgr.getTags();
    ...
    const tagRoot = dictionariesMgr.dictionaries.find(
      ele => ele.itemParentId === null && ele.rootIndex === -8
    );
    this.setState({ level1Root: tagRoot });
      ...
      <Card>
        ...
        <Modal
          ...
          onOk={async () => {
            ...
            if (newLevel1Item.itemName && newLevel1Item.sortIndex !== null) {
