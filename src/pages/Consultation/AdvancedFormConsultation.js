...
class AdvancedForm extends PureComponent {
  ...
  render() {
    ...
    const { width, dictionary, loading } = this.state;
              ...
              <Card className={styles.card} bordered={false}>
                <Form layout="vertical" hideRequiredMark>
                  <Row gutter={16} style={{ marginBottom: 4 }}>
                    ...
                    <Col span={4}>
                      <Select
                        defaultValue={formatMessage({ id: 'customerForm.form1001' })}
              ...
              <Card className={styles.card} bordered={false}>
                <Form layout="inline">
                  <Row style={{ marginBottom: 4 }}>
                    <Form.Item label={formatMessage({ id: 'customerForm.form31' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 935 }}
                  ...
                  <Row style={{ marginBottom: 4 }}>
                    <Form.Item label={formatMessage({ id: 'customerForm.form32' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 420 }}
                    ...
                    <Form.Item label={formatMessage({ id: 'customerForm.form33' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 410 }}
                  ...
                  <Row>
                    <Form.Item label={formatMessage({ id: 'customerForm.form34' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 397 }}
                    ...
                    <Form.Item label={formatMessage({ id: 'customerForm.form35' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 400 }}
                  ...
                  <Row>
                    <Form.Item label={formatMessage({ id: 'customerForm.form36' })}>
                      <Select
                        allowClear
                        mode="multiple"
                        style={{ width: 920 }}
              ...
              <Card className={styles.card} bordered={false}>
                <Form layout="vertical" hideRequiredMark>
                  ...
                  <Row gutter={16} style={{ marginBottom: 10 }}>
                    ...
                    <Col span={4}>
                      <DatePicker
                        ...
                        onChange={value => {
                          if (value) dataSource.timeDay = value.format('YYYY-MM-DD');
                          else dataSource.timeDay = null;
                        }}
                      />
                    </Col>
                    <Col span={4}>
                      <Input
                        defaultValue="00:00"
                        onChange={value => {
                          if (value) dataSource.timeHM = value;
                          else dataSource.timeHM = null;
                        }}
                      />
                    </Col>
                  </Row>
                  <Row>
                    ...
                    <Button type="primary" size="small" style={{ marginRight: 56 }}>
                      19时
                    </Button>
                    <Button
                      type="primary"
                      size="small"
                      style={{ marginRight: 6, backgroundColor: '#27AE60', borderColor: '#27AE60' }}
                    >
                      0分
                    </Button>
                    <Button
